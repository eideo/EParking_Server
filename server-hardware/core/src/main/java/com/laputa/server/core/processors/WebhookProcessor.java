...
import com.laputa.server.core.model.widgets.others.webhook.SupportedWebhookMethod;
...
import static com.laputa.server.core.protocol.enums.Command.WEB_HOOKS;
...
public class WebhookProcessor extends NotificationBase {
    ...
    private void buildRequestBody( String header, String body) {
        switch (header) {
