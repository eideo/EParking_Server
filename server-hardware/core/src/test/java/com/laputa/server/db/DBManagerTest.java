...
import com.laputa.server.core.reporting.average.AverageAggregatorProcessor;
import com.laputa.server.db.dao.ReportingDBDao;
...
//            System.out.println(res);
    ...
    public void testUpsertUserFieldUpdated() throws Exception {
        ...
        try (Connection connection = dbManager.getConnection();
            ...
            while (rs.next()) {
                ...
                assertEquals("{\"dashBoards\":[{\"id\":1,\"name\":\"123\",\"createdAt\":0,\"updatedAt\":0,\"theme\":\"Laputa\",\"keepScreenOn\":false,\"isAppConnectedOn\":false,\"isShared\":false,\"isActive\":false}]}", rs.getString("json"));
            }
            connection.commit();
        }
    }
    ...
    public void testInsertAndGetUser() throws Exception {
        ...
        assertEquals("{\"dashBoards\":[{\"id\":1,\"parentId\":-1,\"isPreview\":false,\"name\":\"123\",\"createdAt\":0,\"updatedAt\":0,\"theme\":\"Laputa\",\"keepScreenOn\":false,\"isAppConnectedOn\":false,\"isShared\":false,\"isActive\":false}]}", dbUser.profile.toString());
